...
<div class="popup">
		...
		<div class="con">
		<!--폼 시작-->
<input type="button" onclick="seat()" class="seat" value="스터디룸" style="text-align: center; width: 100px; border: 2px solid black; background-color: #ffffff; color: rgb(0, 0, 0); margin: 2px;">
...
<div class="box_payment">
        <div class="box_payment_01">3시간권<br><br>
            <div id="box_payment_02">3시간</div>
            <div id="box_payment_02">3,000원
                <input type="hidden" id="" name="" value="3시간">
		...
		<!-- js -->
		<script type="text/javascript">
			function kiosk_login_go(){
				alert("결제가 취소되었습니다.처음화면으로 되돌아갑니다.");
				location.href="kiosk_login";
			}
		</script>
		
		<div class="txt_center" style="float: left; margin-left: 130px;">
			<a onclick = "" class="btn_type1" id="kiosk_seat">결제하기</a>
		</div>
		<div class="txt_center" style="float: left; margin-left: 100px;">
			<a onclick = "kiosk_login_go()" class="btn_type1" id="pay_close">결제취소</a>
		</div>
